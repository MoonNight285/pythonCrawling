...
serviceKey = "pAR7xB7Uwyh4RcIMj1YNS9nYmjzzbIEm%2BTOpaJa1IxsC%2FB7J96c6jR5lABRfJjfLbB323p8xThlPinRbLSe6pw%3D%3D"
...
def main() :
    ...
    nEndYear = int(input("데이터를 몇 년부터 수집할까요? : "))
    ed_cd = input("데이터의 종류를 선택하세요(E : 방한 외래 관광객, D : 해외 출국)") # E: 방한 외래 관광객, D : 해외 출국
